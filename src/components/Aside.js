...
import AsideRestaurantsList from './AsideRestaurantsList';
            ...
            <div className='col-lg-10 col-xl-10 col-md-12 col-sm-12 aside-content '>
              <Row>
                <div className='col-10'>
                  <h1 className='tittle' > GoodMeal!</h1>
                </div>
              </Row>
              ...
              <AsideRestaurantsList restaurantLists={props.restaurantLists} ></AsideRestaurantsList>
            </div>
